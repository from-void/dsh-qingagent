...
const QING_SOURCE_ALIASES = {
  ...
  uuid: UUID_BROWSER,
  '@qingagent/ui-kit/tokens.css': `${QING_ROOT}/packages/ui-kit/src/tokens.css`,
  '@qingagent/ui-kit/base.css': `${QING_ROOT}/packages/ui-kit/src/base.css`,
  '@qingagent/ui-kit/components.css': `${QING_ROOT}/packages/ui-kit/src/components.css`,
  '@qingagent/ui-kit': `${QING_ROOT}/packages/ui-kit/src/index.ts`,
